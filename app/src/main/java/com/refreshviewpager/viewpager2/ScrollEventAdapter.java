...
import static com.refreshviewpager.viewpager2.ViewPager2.ORIENTATION_HORIZONTAL;
import static com.refreshviewpager.viewpager2.ViewPager2.SCROLL_STATE_DRAGGING;
import static com.refreshviewpager.viewpager2.ViewPager2.SCROLL_STATE_IDLE;
import static com.refreshviewpager.viewpager2.ViewPager2.SCROLL_STATE_SETTLING;
...
public class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        ScrollEventAdapter.ScrollEventValues values = updateScrollEventValues();
     ...
     */
    private ScrollEventAdapter.ScrollEventValues updateScrollEventValues() {
        ...
        ViewGroup.MarginLayoutParams margin =
                (firstVisibleView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)
                        ? (ViewGroup.MarginLayoutParams) firstVisibleView.getLayoutParams()
